...
| 1.3.0 | 2026-06-13 | Phase 4: Groups & Memberships complete; implemented CRUD endpoints, timeline-aware memberships (with non-overlapping re-joins), computed status, GroupMemberGuard, and verified via unit tests. |
